    ...
    try {
        ...
        if(!MCProfile) {
            return Promise.reject({
                message: 'Le compte avec lequel vous essayez de vous connecter n’a pas acheté une copie de Minecraft. Vous pouvez acheter une copie sur <a href="https://minecraft.net/">Minecraft.net</a>.'
            })
        }
